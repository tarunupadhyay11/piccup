    ...
    render() {
        ...
        return (
            <SafeAreaView>
                <ScrollView>
                    <View style={{flex:1,}} >
                        <ImageBackground style={coverBg} source={require('../../lib/assets/img/up.jpg')}></ImageBackground>
                        <View style={dpContainer} >
                            ...
                            <TouchableOpacity style={{position:'absolute',top:15,right:15,zIndex:999,backgroundColor:'#fff',borderColor:'#bbb',borderWidth:1,borderRadius:100,paddingHorizontal:8,paddingVertical:5}}>
                                <Icon name="md-heart" size={25} style={{color:'#ff4343'}} />
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={slider}>
                            ...
                            <View style={{marginTop:5}}>
                                ...
                                <View style={{flexDirection:'row',marginBottom:15}}>
                                    ...
                                    <Text numberOfLines={1} style={hdng}>Achievements </Text>
                                    </TouchableOpacity>
                                    </View>
                                </View>
...
const styles = StyleSheet.create({
    ...
    dp:{flex:1,height:null,width:null,resizeMode:'contain',backgroundColor:'#fff',},
